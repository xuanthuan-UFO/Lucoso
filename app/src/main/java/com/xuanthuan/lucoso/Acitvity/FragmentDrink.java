...
public class FragmentDrink extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_drink, container, false);

        refreshLayout = view.findViewById(R.id.refreshdrink);
        arraylist = new ArrayList<>();
        addDataList();
        listView = view.findViewById(R.id.listdrink);
    ...
    private void addDataList() {
        arraylist.clear();
        Cursor data = ActivityHome.dataBase.getData("SELECT * FROM Drink");
