...
public class FragmentMainFood extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_mainfood, container, false);

        refreshLayout = view.findViewById(R.id.refreshmainfood);
        arraylist = new ArrayList<>();
        addDataList();
        listView = view.findViewById(R.id.listMainFood);
    ...
    private void addDataList() {
        arraylist.clear();
        Cursor data = ActivityHome.dataBase.getData("SELECT * FROM MainFood");
